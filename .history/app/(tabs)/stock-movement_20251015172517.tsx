...
import { stockMovementService } from '../../services/stockMovmentService'; // Fixed typo
...
export default function StockMovementScreen() {
  ...
  const { products, refreshProducts } = useAppContext(); // Added refreshProducts
  ...
  const updateProduct = (index: number, field: keyof ProductSelection, value: string) => {
    ...
    // If updating productId, also update productName and unit
  ...
  const selectProduct = (product: any) => {
    if (activeProductIndex !== null) {
      // Update all product fields at once
      const updated = [...selectedProducts];
      updated[activeProductIndex] = {
        productId: product.id,
        productName: product.name,
        quantity: updated[activeProductIndex].quantity, // Keep existing quantity
  ...
  // Product Dropdown Modal - IMPROVED
                ...
                >
                  <View style={styles.productInfo}>
                    ...
                    <Text style={styles.productUnit}>
                      Unit: {item.unit || 'units'} • Stock: {item.quantity || 0}
                    </Text>
                  </View>
                  {isSelected && (
              ...
              <View style={styles.productForm}>
                ...
                <View style={styles.inputGroup}>
                  ...
                  <View style={styles.unitDisplay}>
                    <Text style={styles.unitText}>{product.unit || 'Not selected'}</Text>
                  </View>
                </View>
              </View>
            </View>
