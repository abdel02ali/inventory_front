    ...
    >
      <View style={styles.productMain}>
        <View style={[styles.productStatus, { 
          backgroundColor: product.alertLevel === 'Out of Stock' ? '#FF6B6B' : '#FFA726' 
        }]} />
      ...
      <View style={styles.productStock}>
        <Text style={[styles.stockValue, { 
          color: product.alertLevel === 'Out of Stock' ? '#FF6B6B' : '#FFA726' 
        }]}>
  ...
  if (loading) {
    return (
      <View style={[styles.container, styles.loadingContainer]}>
        ...
        <Text style={[styles.loadingText, { color: isDarkMode ? "#FFFFFF" : "#1A1D21" }]}>
          Loading dashboard...
        </Text>
      </View>
    );
        ...
        <View style={styles.section}>
          ...
          <View style={styles.quickActionsGrid}>
            ...
            <QuickAction 
              ...
              onPress={() => router.push('/stock-movement' as any)}
            />
            <QuickAction 
              icon="🏢" 
