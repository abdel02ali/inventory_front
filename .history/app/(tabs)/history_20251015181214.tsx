...
export default function HistoryScreen() {
  ...
  // Statistics - calculate from ALL movements (not filtered) for accurate totals
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerSubtitle}>All stock movements</Text>
      </View>
