...
export default function ProductsScreen() {
  ...
  // Dans ProductsScreen.tsx - Remplacer la fonction fetchProducts
  ...
  try {
    ...
    const normalizedProducts = (res.data.data || res.data || []).map((product: any) => {
      ...
      return {
        ...
        lastUsed: lastUsed,
        usageHistory: usageHistory, // Include usage history
      };
    });
        ...
        onPress={() =>
          router.push({
            ...
            params: { 
              ...
              usageHistory: JSON.stringify(item.usageHistory || []), // Add usage history
            },
          })
        }
        activeOpacity={0.7}
...
const getStyles = (isDarkMode: boolean) => StyleSheet.create({
  container: {
    ...
    paddingTop: 50, // Added padding to replace SafeAreaView
  },
  header: {
    backgroundColor: "#f97316" ,
    padding: 20,
    paddingTop: 20, // Reduced top padding since we have container padding
  ...
  listContent: {
    padding: 8,
    flexGrow: 1,
    paddingBottom: 100, // Added bottom padding to ensure last items are visible
  },
  listContentExpanded: {
    paddingTop: 0,
  },
