...
export default function Dashboard() {
  ...
  const ProductItem = ({ product }: { product: DashboardProduct }) => (
    <TouchableOpacity 
      style={[styles.productItem, { backgroundColor: isDarkMode ? "#1F2937" : "#FFFFFF" }]}
      onPress={() => router.push({
    ...
    >
      <View style={[styles.modalContainer, { backgroundColor: isDarkMode ? "#111827" : "#F9FAFB" }]}>
        <View style={styles.modalHeader}>
          ...
          <TouchableOpacity 
            style={[styles.closeButton, { backgroundColor: isDarkMode ? "#374151" : "#E5E7EB" }]}
        ...
        <View style={[styles.searchContainer, { backgroundColor: isDarkMode ? "#1F2937" : "#FFFFFF" }]}>
          <Ionicons name="search" size={18} color={isDarkMode ? "#6B7280" : "#9CA3AF"} />
          <TextInput
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <TouchableOpacity 
              style={[styles.modalDepartmentItem, { backgroundColor: isDarkMode ? "#1F2937" : "#FFFFFF" }]}
              onPress={() => {
            ...
            >
              ...
              <Ionicons name="chevron-forward" size={16} color={isDarkMode ? "#4B5563" : "#9CA3AF"} />
            </TouchableOpacity>
          )}
