...
const getStyles = (isDarkMode: boolean) => StyleSheet.create({
  ...
  // Product Cards (using same structure as AddInvoiceScreen)
  productCard: {
    backgroundColor: isDarkMode ? "#1e293b" : "#ffffff",
    padding: 12,
    borderRadius: 12,
  ...
  // Dropdown Styles (consistent with AddInvoiceScreen)
  dropdownTrigger: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
  ...
  // Add Product Button (consistent with AddInvoiceScreen)
  addProductBtn: {
  ...
  // Modal Styles (consistent with AddInvoiceScreen)
  modalOverlay: {
    flex: 1,
  ...
  // Add New Product Button (consistent with AddInvoiceScreen)
  addNewButton: {
  ...
  // Submit Button (consistent with AddInvoiceScreen)
  actionButtons: {
    marginTop: 24,
    marginBottom: 30,
    gap: 12,
...
export default function StockMovementScreen() {
  ...
  // Product Dropdown Modal with refresh functionality
