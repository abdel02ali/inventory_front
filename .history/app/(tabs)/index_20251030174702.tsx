      ...
      <View style={styles.datePickerOverlay}>
        <View style={styles.datePickerContainer}>
          ...
          <TouchableOpacity 
            ...
            onPress={() => applyDateFilter(today, today)}
          >
          ...
          <TouchableOpacity 
            style={styles.quickDateButton}
            onPress={() => applyDateFilter(yesterday, yesterday)}
          >
          ...
          <TouchableOpacity 
            style={styles.quickDateButton}
            onPress={() => applyDateFilter(lastWeek, today)}
          >
          ...
          <TouchableOpacity 
            style={styles.quickDateButton}
            onPress={() => applyDateFilter(lastMonth, today)}
          >
