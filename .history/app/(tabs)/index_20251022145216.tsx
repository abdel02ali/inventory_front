...
export default function Dashboard() {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      // CORRECTION : Adapter les données de l'API aux champs attendus
      ...
      const adaptedStats: DashboardStats = {
        ...
        outOfStock: apiData.lowStockItems || 0, // Utiliser lowStockItems comme outOfStock
        totalDepartments: 0 // Sera mis à jour plus tard avec les départments
      };
      ...
      try {
        ...
        // Mettre à jour le count des départments
        setStats(prev => ({
          ...prev,
        ...
        // Si erreur, garder 0 pour totalDepartments
      }
