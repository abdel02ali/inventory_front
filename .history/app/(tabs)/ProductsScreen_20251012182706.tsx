...
export default function ProductsScreen() {
  ...
  // Mock images for products that don't have images
  const getProductImage = (product: Product) => {
    ...
    return categoryImages[product.category] || 'https://images.unsplash.com/photo-1546548970-71785318a17b?w=400&h=400&fit=crop';
  };
