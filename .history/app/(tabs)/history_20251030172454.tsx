...
export default function HistoryScreen() {
  ...
  const { departments, loading: loadingDepartments, error: departmentsError, refreshDepartments } = useDepartments();

  // Refresh departments when screen comes into focus
  useFocusEffect(
    useCallback(() => {
      refreshDepartments();
    }, [refreshDepartments])
  ...
  // Handle department refresh specifically
      ...
      <View style={styles.filtersContainer}>
        ...
        <View style={styles.departmentFilterContainer}>
          <View style={styles.departmentHeader}>
            ...
            <TouchableOpacity 
              onPress={handleDepartmentRefresh} 
