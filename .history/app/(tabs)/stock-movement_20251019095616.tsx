...
useEffect(() => {
  if (productDropdownVisible) {
    ...
    const refreshProductsOnOpen = async () => {
      await refreshProducts();
    };
    refreshProductsOnOpen();
  }
}, [productDropdownVisible]); // <-- Add productDropdownVisible as dependency // <-- empty dependency array // <-- empty dependency array
