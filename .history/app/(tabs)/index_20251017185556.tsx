...
export default function Dashboard() {
  ...
  // In your dashboard component, update the loadDashboardData function:
...
const loadDashboardData = async () => {
  try {
    ...
    // Try to load departments separately with error handling
    try {
      const departmentsResponse = await departmentService.getDepartments();
      setDepartments(departmentsResponse.slice(0, 5));
      setStats(prev => ({
        ...prev,
      ...
      console.error('❌ Error loading departments, using fallback:', deptError);
      // Departments will remain as empty array, but other data will show
    }
