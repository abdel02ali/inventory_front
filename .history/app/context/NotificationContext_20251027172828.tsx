...
export const NotificationProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  // Initialize weekly reports when component mounts and when settings change
  useEffect(() => {
    const initializeWeeklyReports = async () => {
      if (settings.weeklyReportEnabled && isInitialized) {
  ...
  }, [settings.weeklyReportEnabled, isInitialized]);
