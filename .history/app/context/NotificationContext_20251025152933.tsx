...
interface NotificationContextType {
  ...
  scheduleStockInAlert: (productCount: number, supplier: string, totalValue?: number, stockManager?: string) => Promise<void>;
  scheduleDistributionAlert: (productCount: number, department: string, stockManager?: string) => Promise<void>;
