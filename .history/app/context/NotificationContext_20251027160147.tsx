...
export const NotificationProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  // In your NotificationContext.tsx - Update the generateWeeklyReport function
const generateWeeklyReport = async (): Promise<WeeklyReportData | null> => {
  try {
    ...
    // Realistic report data based on the example
    ...
    setWeeklyReports(prev => [realisticReport, ...prev.slice(0, 9)]); // Keep last 10 reports
    
    console.log('✅ Weekly report generated with realistic data');
