...
export default function AddProductScreen() {
  ...
  // Your custom categories for restaurant inventory
  ...
  const addCustomCategory = () => {
    ...
    // Check if it exists in predefined categories
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.inputGroup}>
        ...
        <View style={styles.customCategoryContainer}>
          ...
          <Text style={styles.helperText}>
            Create a new category if you can't find it in the list above
          </Text>
          <View style={styles.customCategoryRow}>
            ...
            <TouchableOpacity 
              style={[
                ...
                (!customCategory.trim() || selectedCategories.includes(customCategory.trim()) || categoryOptions.includes(customCategory.trim())) && 
                styles.addCustomButtonDisabled
              ]}
              onPress={addCustomCategory}
              disabled={!customCategory.trim() || selectedCategories.includes(customCategory.trim()) || categoryOptions.includes(customCategory.trim())}
            >
              <Text style={styles.addCustomButtonText}>Add</Text>
            </TouchableOpacity>
          </View>
          {customCategory.trim() && categoryOptions.includes(customCategory.trim()) && (
              ...
              {selectedCategories.map((category, index) => (
                <View key={category} style={styles.selectedCategoryTag}>
                  <Text style={styles.selectedCategoryText}>
                    {index === 0 && "🏠 "}{category}
                    {!categoryOptions.includes(category) && " (custom)"}
                  </Text>
                  <TouchableOpacity 
      ...
      <View style={styles.helpContainer}>
        <Text style={styles.helpText}>
          💡 <Text style={styles.helpBold}>Using Your Categories:</Text> 
          {"\n"}• Products will be organized by your custom categories
