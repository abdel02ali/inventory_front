...
export default function AddProductScreen() {
  ...
  return (
    <ScrollView style={styles.container}>
      <Stack.Screen options={{ title: "Add New Product" ,headerShown: false ,}} />
      ...
      <View style={styles.inputGroup}>
        ...
        <TextInput
          style={styles.input}
          placeholder="e.g., Vegetables, Fruits, Meat, Dairy"
          placeholderTextColor={isDarkMode ? "#94a3b8" : "#64748b"}
          value={category}
      ...
      <View style={styles.helpContainer}>
        <Text style={styles.helpText}>
          💡 <Text style={styles.helpBold}>Tip:</Text> Use descriptive names and categories to make products easier to find later.
        </Text>
      </View>
    </ScrollView>
  );
