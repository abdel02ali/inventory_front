...
export default function ProductDetailScreen() {
  ...
  const handleAddToStock = () => {
    ...
    setAddAmount("");
    Alert.alert("Success", `${amount} ${editedUnit} added to stock!`);
  };
            ...
            <View style={styles.fieldRow}>
              ...
              <View style={styles.fieldContent}>
                ...
                <View style={styles.quantityRow}>
                  ...
                  <Text style={styles.quantityUnit}>{editedUnit}</Text>
                </View>
              </View>
            </View>
            ...
            <View style={styles.fieldRow}>
              ...
              <View style={styles.fieldContent}>
                ...
                {isEditing ? (
                    ...
                    <View style={styles.unitButtonsContainer}>
                      {unitOptions.map((unitOption) => (
                        <TouchableOpacity
                          ...
                          style={[
                            styles.unitButton,
                            editedUnit === unitOption && styles.unitButtonActive
                          ]}
                          onPress={() => setEditedUnit(unitOption)}
                        >
                          <Text style={[
                            styles.unitButtonText,
                            editedUnit === unitOption && styles.unitButtonTextActive
                          ]}>
                            {unitOption}
                          </Text>
                        </TouchableOpacity>
                  ...
                  <Text style={styles.fieldValue}>{editedUnit}</Text>
                )}
              </View>
            </View>
            ...
            <View style={styles.fieldRow}>
              ...
              <View style={styles.fieldContent}>
                ...
                {isEditing ? (
                  ...
                  <Text style={styles.fieldValue}>{editedCategory}</Text>
                )}
              </View>
            </View>
            ...
            <View style={styles.fieldRow}>
              ...
              <View style={styles.fieldContent}>
                ...
                {isEditing ? (
                  ...
                  <Text style={[styles.fieldValue, styles.descriptionText]}>
        ...
        {!isEditing && (
          <View style={styles.card}>
            ...
            <View style={styles.stockContent}>
              <Text style={styles.stockTitle}>Add to Inventory</Text>
              ...
              <View style={styles.stockInputContainer}>
                <TextInput
                  ...
                  placeholder={`Enter ${editedUnit} to add`}
                  placeholderTextColor={isDarkMode ? "#94a3b8" : "#9ca3af"}
                ...
                <TouchableOpacity
                  style={[
                    styles.addButton,
                    (!addAmount || parseInt(addAmount) <= 0) && styles.addButtonDisabled
                  ]}
