...
const API_BASE_URL = 'http://localhost:3001/api'; // Change to your actual server IP if needed
        ...
        <>
          ...
          <View style={styles.footer}>
            ...
            <Text style={styles.footerSubtext}>
              Period: {reportData.period} • {reportData.dateRange.startDate.split('T')[0]} to {reportData.dateRange.endDate.split('T')[0]}
            </Text>
          </View>
        </>
      ) : (
