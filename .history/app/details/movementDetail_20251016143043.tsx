...
export default function MovementDetailsScreen() {
    ...
    const loadMovementDetails = async () => {
        try {
            setLoading(true);
            const movementData = await stockMovementService.getMovementById(movementId as string);
            setMovement(movementData);
        } catch (error) {
            console.error('Error loading movement details:', error);
            Alert.alert('Error', 'Failed to load movement details');
        } finally {
            setLoading(false);
        }
    };
            ...
            [
                { text: 'Cancel', style: 'cancel' },
                {
                    ...
                    onPress: async () => {
                        try {
                            setDeleting(true);
                            const result = await stockMovementService.deleteMovement(movement.id);
    ...
    return (
        <View style={styles.container}>
            ...
            >
                ...
                {/* Products List */}
                <View style={styles.section}>
                    <Text style={styles.sectionTitle}>Products ({movement.products.length})</Text>
                            ...
                            <View style={styles.productDetails}>
                                ...
                                <View style={styles.stockChange}>
                                    ...
                                    <View style={styles.stockValues}>
                                        <Text style={styles.stockPrevious}>
                                        ...
                                        <View style={[
                                            ...
                                            product.newStock > product.previousStock 
