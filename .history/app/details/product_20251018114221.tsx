...
export default function ProductDetailScreen() {
  ...
  const { id, name, quantity: q, unit, category, description, lastUsed } = useLocalSearchParams();
  ...
  const getLastUsedFromParams = () => {
    const lastUsedParam = Array.isArray(lastUsed) ? lastUsed[0] : lastUsed;
  ...
  const lastUsedDate = getLastUsedFromParams();
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.details}>
            ...
            {/* Last Used - Display Only */}
            {!isEditing && (
              <View style={styles.detailRow}>
                <Text style={styles.label}>Last Used</Text>
                <Text style={styles.value}>{formatDate(lastUsedDate)}</Text>
              </View>
            )}
          </View>
