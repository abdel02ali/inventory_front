...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (result.success) {
      ...
      // =============================================
      // MOVEMENT NOTIFICATION TRIGGER WITH PRODUCT NAMES AND QUANTITIES
      // =============================================
      ...
      if (movementType === 'stock_in') {
        ...
        console.log('📢 Triggering stock in notification:', {
        ...
        console.log('📢 Triggering distribution notification:', {
          productCount: selectedProducts.length,
          productNames,
