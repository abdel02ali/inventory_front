...
const getProductStock = (product: any) => {
  ...
  try {
    ...
    const movementData: StockMovementData = {
      type: movementType,
      stockManager: 'Ahmed', // You can get this from user context
    ...
    if (result.success) {
      ...
      // =============================================
      // MOVEMENT NOTIFICATION TRIGGER WITH PRODUCT NAMES
      // =============================================
      
      // Extract product names from selected products (just names for now)
      const productNames = selectedProducts
        .map(product => product.productName)
        .filter(name => name && name.trim() !== ''); // Filter out empty names

      console.log('📦 Product names for notification:', productNames);
      ...
      if (movementType === 'stock_in') {
        ...
        console.log('📢 Triggering stock in notification with product names:', {
        ...
        await scheduleStockInAlert(
          ...
          supplier,
          totalValue,
          'Ahmed', // You can get this from user context
          productNames // PASS PRODUCT NAMES AS STRING[]
        );
      } else {
        console.log('📢 Triggering distribution notification with product names:', {
          productCount: selectedProducts.length,
          productNames,
