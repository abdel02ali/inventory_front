...
export default function ProductAnalyticsScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      >
       // In the return section, replace the Summary Card section with this:
...
<View style={styles.card}>
  ...
  >
    ...
    <View style={styles.horizontalCard}>
      ...
      <View style={styles.horizontalCardContent}>
        <Text style={styles.horizontalCardValue}>{formatNumber(analytics.summary.averageMonthlyUsage)}</Text>
    ...
    <View style={styles.horizontalCard}>
      ...
      <View style={styles.horizontalCardContent}>
        <Text style={styles.horizontalCardValue}>{formatNumber(analytics.summary.estimatedMonthsRemaining)}</Text>
        ...
        <View style={styles.card}>
          <View style={styles.cardHeader}>
            ...
            <View style={styles.cardTitleContainer}>
              ...
              <Text style={styles.cardSubtitle}>{analytics.currentMonth.period}</Text>
            </View>
            ...
            <View style={styles.projectionItem}>
              ...
              <View style={styles.projectionTextContainer}>
                ...
                <Text style={[styles.projectionValue, styles.projectionHighlight]}>
                  {formatNumber(analytics.summary.estimatedMonthsRemaining)} months
                </Text>
              </View>
            </View>
          </View>
