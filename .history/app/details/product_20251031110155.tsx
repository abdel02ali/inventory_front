...
export default function ProductDetailScreen() {
  ...
  // Get only the 3 latest movements
  const getLatestMovements = () => {
    // Sort by date/timestamp in descending order (newest first) and take first 3
  ...
  const latestMovements = getLatestMovements();

  // Navigate to analytics screen
  const handleViewAnalytics = () => {
    router.push({
      pathname: "./product-analytics",
      params: {
        productId,
        productName: getName(),
        unit: getUnit(),
            ...
            <View style={styles.analyticsButtonContent}>
              ...
              <View style={styles.analyticsTextContainer}>
                ...
                <Text style={styles.analyticsSubtitle}>
                  Detailed statistics, trends, and full history
                </Text>
              </View>
        ...
        {!isEditing && (
          <View style={styles.card}>
            <View style={styles.cardHeader}>
              ...
              <Text style={styles.cardTitle}>Latest Movements</Text>
              <View style={styles.historyCountBadge}>
                <Text style={styles.historyCountText}>{latestMovements.length}/3</Text>
              </View>
            </View>
                ...
                {usageHistory.length > 3 && (
                  ...
                  >
                    <Text style={styles.viewAllText}>
                      View All {usageHistory.length} Movements
                    </Text>
