...
export default function ProductSelectionModal({
  ...
  const fetchProducts = async () => {
    try {
      ...
      console.log('✅ ProductSelectionModal: Products fetched successfully', productsData.length);
            ...
            <View style={styles.modalContainer}>
              ...
              <View style={styles.debugInfo}>
                <Text style={styles.debugText}>
                  Products: {products.length} | Filtered: {filteredProducts.length} | Loading: {loading.toString()}
                </Text>
              </View>
...
const getStyles = (isDarkMode: boolean) => StyleSheet.create({
  ...
  debugText: {
    fontSize: 12,
    color: isDarkMode ? '#fef3c7' : '#7c2d12',
    textAlign: 'center',
    fontWeight: '600',
  },
  // FIXED: Products container with proper flex
  productsContainer: {
    flex: 1,
