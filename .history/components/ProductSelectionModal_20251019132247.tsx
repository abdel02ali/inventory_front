...
export default function ProductsScreen() {
  ...
  const hasValidCategory = (product: Product): boolean => {
    const hasCategories = product.categories && 
                         Array.isArray(product.categories) && 
                         product.categories.some(cat => cat && cat.trim() !== '');
    const hasCategory = product.category && product.category.trim() !== '';
    const hasPrimaryCategory = product.primaryCategory && product.primaryCategory.trim() !== '';
    
    return hasCategories || hasCategory || hasPrimaryCategory;
  };
